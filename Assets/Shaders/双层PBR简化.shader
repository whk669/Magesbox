...
Shader "SinCourse/双层PBR简化"
{
	Properties
	{
		_DiffuseIndensity("DiffuseIndensity", Float) = 1
		_SubDiffuseIndensity("SubDiffuseIndensity", Float) = 1
		[HDR]_Color("Color", Color) = (1,1,1,1)
		_MainDiffuse("MainDiffuse", 2D) = "white" {}
		_MainDiffuseU("MainDiffuseU", Float) = 0
		_MainDiffuseV("MainDiffuseV", Float) = 0
		[HDR]_SubColor("SubColor", Color) = (1,1,1,1)
		_SubDiffuse("SubDiffuse", 2D) = "white" {}
		_SubDiffuseU("SubDiffuseU", Float) = 0
		_SubDiffuseV("SubDiffuseV", Float) = 0
		[Normal]_MainNormal("MainNormal", 2D) = "bump" {}
		_MainNormalScale("MainNormalScale", Float) = 1
		_MainNormalU("MainNormalU", Float) = 0
		_MainNormalV("MainNormalV", Float) = 0
		[Normal]_SubNormal("SubNormal", 2D) = "bump" {}
		_SubNormalScale("SubNormalScale", Float) = 1
		_SubNormalU("SubNormalU", Float) = 0
		_SubNormalV("SubNormalV", Float) = 0
		_MainSecTex("MainSecTex", 2D) = "white" {}
		_MainSecTexU("MainSecTexU", Float) = 0
		_MainSecTexV("MainSecTexV", Float) = 0
		_SubSecTex("SubSecTex", 2D) = "white" {}
		_SubSecTexU("SubSecTexU", Float) = 0
		_SubSecTexV("SubSecTexV", Float) = 0
		_Alpha("Alpha", 2D) = "white" {}
		_AlphaU("AlphaU", Float) = 0
		_AlphaV("AlphaV", Float) = 0
		_AddAlpha("AddAlpha", 2D) = "white" {}
		_AddAlphaU("AddAlphaU", Float) = 0
		_AddAlphaV("AddAlphaV", Float) = 0
		[Toggle]_AlphaDistortionTexInfluenceDetailAlpha("AlphaDistortionTexInfluenceDetailAlpha", Float) = 0
		_DetailAlpha("DetailAlpha", 2D) = "white" {}
		_DetailAlphaU("DetailAlphaU", Float) = 0
		_DetailAlphaV("DetailAlphaV", Float) = 0
		[Toggle]_AlphaDistortionTexInfluenceAddAlpha("AlphaDistortionTexInfluenceAddAlpha", Float) = 0
		_AlphaBias("AlphaBias", Float) = 0
		_AlphaDistortionTex("AlphaDistortionTex", 2D) = "white" {}
		[Toggle]_AlphaDistortion2UV("AlphaDistortion2UV", Float) = 0
		_DistortionIndensity("DistortionIndensity", Float) = 0
		_AlphaDistortionU("AlphaDistortionU", Float) = 0
		_AlphaDistortionV("AlphaDistortionV", Float) = 0
		_AlphaDistortionMask("AlphaDistortionMask", 2D) = "white" {}
		[Toggle]_AlphaDistortionMask2UV("AlphaDistortionMask2UV", Float) = 0
		_AlphaDistortionMaskU("AlphaDistortionMaskU", Float) = 0
		_AlphaDistortionMaskV("AlphaDistortionMaskV", Float) = 0
		_MainAO("MainAO", Float) = 0
		_MainGloss("MainGloss", Float) = 1
		_MainMetallic("MainMetallic", Float) = 1
		_SubAO("SubAO", Float) = 0
		_SubGloss("SubGloss", Float) = 1
		_SubMetallic("SubMetallic", Float) = 1
		_SubEmission("SubEmission", 2D) = "white" {}
		_SubEmissionU("SubEmissionU", Float) = 0
		_SubEmissionV("SubEmissionV", Float) = 0
		[HDR]_SubEmissionColor("SubEmissionColor", Color) = (1,1,1,1)
		_SubEmissionIndensity("SubEmissionIndensity", Float) = 1
		_MainCubemap("MainCubemap", CUBE) = "white" {}
		_MainCubemapIndensity("MainCubemapIndensity", Float) = 1
		_SubCubemap("SubCubemap", CUBE) = "white" {}
		_SubCubemapIndensity("SubCubemapIndensity", Float) = 1
