...
Shader "SinVFX/ASE_RefractionDistortion"
{
	Properties
	{
		_Distortion_Tex("Distortion_Tex", 2D) = "white" {}
		[Toggle(_DISTORTION_TEX2UV_ON)] _Distortion_Tex2UV("Distortion_Tex2UV", Float) = 0
