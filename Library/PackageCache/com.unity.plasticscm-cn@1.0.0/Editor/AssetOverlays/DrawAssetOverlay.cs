...
namespace Unity.PlasticSCM.Editor.AssetsOverlays
{
    internal static class DrawAssetOverlay
    {
        ...
        static AssetStatus GetStatusesToDraw(AssetStatus status)
        {
        ...
        static string GetStatusString(AssetStatus statusValue)
        {
            switch (statusValue)
            {
        ...
        static class DrawOverlayIcon
        {
            ...
            static Texture GetOverlayIcon(AssetStatus status)
            {
                switch (status)
                {
                    case AssetStatus.Ignored:
